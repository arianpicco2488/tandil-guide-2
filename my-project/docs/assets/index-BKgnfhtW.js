(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const s of t.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&r(s)}).observe(document,{childList:!0,subtree:!0});function i(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function r(e){if(e.ep)return;e.ep=!0;const t=i(e);fetch(e.href,t)}})();const d={"Aire Libre":[{name:"Dique de Tandil",img:"images/dique.jpg",link:"https://maps.google.com?q=Dique+de+Tandil",label:"Disfruta de un día al aire libre"},{name:"Parque de los Dinosaurios",img:"images/dinosaurios.jpg",link:"https://maps.google.com?q=Parque+de+los+Dinosaurios",label:"A las 11 los dinosaurios cobran vida"},{name:"Fuerte Independencia",img:"images/fuerte.jpg",link:"https://maps.google.com?q=Fuerte+Independencia",label:"Un paseo histórico"},{name:"Calvario",img:"images/calvario.jpg",link:"https://maps.google.com?q=Calvario+Tandil",label:"Visitar a Jesús en la cima"},{name:"Centinela",img:"images/centinela.jpg",link:"https://maps.google.com?q=Centinela+Tandil",label:"Caminata y recorridos en la naturaleza"},{name:"Movediza",img:"images/movediza.jpg",link:"https://maps.google.com?q=Piedra+Movediza+Tandil",label:"La famosa piedra que se mueve"},{name:"Parque Aéreo",img:"images/parque-aereo.jpg",link:"https://maps.google.com?q=Parque+Aéreo+Tandil",label:"Volar entre los árboles"}],Salamines:[{name:"Época de Quesos",img:"images/epoca.jpg",link:"https://maps.google.com?q=Época+de+Quesos+Tandil",label:"Disfruta de los mejores quesos"},{name:"Syquet",img:"images/syquet.jpg",link:"https://maps.google.com?q=Syquet+Tandil",label:"Quesos y fiambres de calidad"}],"Casa de Ari":[{name:"Casa de Ari",img:"images/casa.jpg",link:"https://maps.app.goo.gl/mBfFKLwXJw68RxGG7",label:"Bienvenida a la casa de Ari"}],Hospedaje:[{name:"Airbnb",img:"images/airbnb.jpg",link:"https://airbnb.com",label:"Encuentra tu lugar ideal"}]};function c({name:a,img:o,link:i,label:r}){const e=document.createElement("div");return e.className="w-full min-w-[250px] group cursor-pointer relative overflow-hidden transform transition-all duration-700 hover:scale-105 hover:rotate-1 hover:shadow-xl hover:-translate-y-2 bg-white/90 backdrop-blur-md rounded-xl shadow-md hover:shadow-emerald-200/40",e.innerHTML=`
    <!-- Animated Border -->
    ...
    <div class="relative z-20 h-72 w-full overflow-hidden rounded-xl">
      <div class="absolute inset-0 bg-cover bg-center blur-[1px] scale-105" style="background-image: url('${o}')"></div>
...
<span class="relative z-10 text-green-800">Google Maps</span>
  ...
  `,e}function m(a,o,i=""){const r=document.createElement("section");r.className="mb-16 relative",r.innerHTML=`
    <!-- Background Pattern -->
    ...
    <div class="relative mb-8">
      <div class="bg-gradient-to-r from-green-300 via-lime-100 to-green-200 rounded-2xl p-6 shadow-md transform hover:scale-105 transition-all duration-300">
        <div class="flex items-center gap-4">
          ...
          <div>
            <h2 class="text-2xl sm:text-3xl font-bold text-green-900 drop-shadow-md">${a}</h2>
    ...
    <!-- Cards Grid -->
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 px-2 sm:px-4" id="sec-${a.replace(/\s/g,"")}"></div>
  `;const e=r.querySelector(`#sec-${a.replace(/\s/g,"")}`);return o.forEach((t,s)=>{const l=c(t);l.classList.add("transform","transition-all","duration-500"),l.style.animationDelay=`${s*100}ms`,e.appendChild(l)}),r}const u=document.getElementById("mainContent");document.addEventListener("DOMContentLoaded",()=>{const a=document.getElementById("mainHeader");window.addEventListener("scroll",()=>{window.scrollY>10?a.classList.add("shadow-xl"):a.classList.remove("shadow-xl")})});const g={"Aire Libre":`
  ...
  `},n=document.createElement("header");n.id="mainHeader";n.className="fixed top-0 left-0 w-full z-50 backdrop-blur-lg";n.innerHTML=`
...
`;document.body.insertBefore(n,document.body.firstChild);Object.entries(d).forEach(([a,o])=>{const i=g[a]||"";u.appendChild(m(a,o,i))});
